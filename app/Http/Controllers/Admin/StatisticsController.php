...
class StatisticsController extends Controller
{
    ...
    public function masleidas()
    {
        ...
        foreach($references as $refs){
            ...
            echo "</pre>";
            /*
            foreach($refs as $indx => $ref) {
            echo $ref->$indx.'<br>';
           /*
            if($indx == 'User-Agent' and array_key_exists($ref->indx, $mores_visit))
                $mores_visit[$ref->$indx] += 1;
            else
            $mores_visit[$ref->$indx] = 1;
        ...
        return $mores_visit;
        return view('admin.statistics.chart', compact('posts'));
    }
