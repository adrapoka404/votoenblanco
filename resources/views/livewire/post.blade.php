<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  my-10 inline-flex">
    <div class="text-center items-center w-2/3 ">
...
<div class="bg-black max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  my-auto h-96 text-white text-center">
Publicidad
</div>
