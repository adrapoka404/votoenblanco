<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 md:flex items-center">
    <div class="w-full md:w-2/3  items-center">
        ...
        <iframe class="py-10 h-96 " width="100%"  src="https://www.youtube.com/embed/xhFivMMvciE"64
            title="YouTube video player" frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen></iframe>
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
            <div>
                <iframe class="mx-auto py-10 w-52 " src="https://www.youtube.com/embed/xhFivMMvciE"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
            </div>
