            ...
            <div class="bg-white px-5 " style="width:100%">
                <div class="">
                    ...
                    <div class=" grid grid-cols-2 gap-4 mt-8">
                        ...
                        <div class="">
                            {!! Form::text('profile[email]', isset($profile->email) ? $profile->email : old('profile.email', ''), ['class' => ' border-wine rounded-lg ml-5 w-96', 'placeholder' => 'Correo electrónico']) !!}
                            @error('profile.email')
                                <x-input-error>{{ $message }}</x-input-error>
                            @enderror
                        </div>
                        <div class="">
                            {!! Form::text('profile[profession]', isset($profile->profession) ? $profile->profession : old('profile.profession', '') , ['class' => ' border-wine rounded-lg mr-5 w-96', 'placeholder' => 'Profesión']) !!}
                        ...
                        <div class="">
                            {!! Form::text('profile[mobile]', isset($profile->mobile) ? $profile->mobile : old('profile.modile', ''), ['class' => ' border-wine rounded-lg ml-5 w-96', 'placeholder' => 'Teléfono']) !!}
